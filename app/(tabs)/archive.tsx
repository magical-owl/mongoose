...
const styles = StyleSheet.create({ root: { flex: 1 }, hero: { borderWidth: 1, borderRadius: 12, padding: 16, marginBottom: 16 }, eyebrow: { fontWeight: '700', letterSpacing: 1, marginBottom: 6 }, title: { fontSize: 24, fontWeight: '700', marginBottom: 4 }, stats: { flexDirection: 'row', gap: 18, marginTop: 16 }, tabs: { gap: 8, paddingBottom: 16 }, tab: { borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8 }, addRow: { flexDirection: 'row', gap: 8, marginBottom: 16 }, input: { flex: 1, borderWidth: 1, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10 }, addButton: { borderRadius: 8, paddingHorizontal: 16, justifyContent: 'center' }, card: { borderWidth: 1, borderRadius: 10, padding: 14, marginBottom: 10, flexDirection: 'row', alignItems: 'center', gap: 12 }, cardIcon: { fontSize: 28 }, moodBadge: { minHeight: 30, borderWidth: 1, borderRadius: 15, paddingHorizontal: 10, alignItems: 'center', justifyContent: 'center' }, moodBadgeText: { fontWeight: '700' }, completeButton: { borderRadius: 8, paddingHorizontal: 10, paddingVertical: 7 }, garden: { borderWidth: 1, borderRadius: 12, padding: 24, alignItems: 'center' }, bookCard: { borderWidth: 1, borderRadius: 10, padding: 14, marginTop: 12 }, gardenIcon: { fontSize: 58 }, gardenStats: { fontSize: 18, fontWeight: '700', marginTop: 24 }, });
