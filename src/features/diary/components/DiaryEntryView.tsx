...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, fontSize: 18, fontWeight: '600', marginRight: 10 },
  ...
  feedTitle: { fontSize: 21, lineHeight: 27, fontWeight: '700', marginBottom: 10 },
  ...
  timelineTitle: { fontSize: 17, fontWeight: '700', marginBottom: 5 },
