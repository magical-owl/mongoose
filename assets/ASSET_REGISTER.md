...
License intent: project-authored original assets for this app. No third-party image inputs, no stock references, no external textures, no logos, no text, no brand marks, no copyrighted characters, and no people. The crayon-like surface treatment uses procedural directional wax strokes, color jitter, alpha gaps, and edge roughening generated by the project script.
