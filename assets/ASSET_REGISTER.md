...
| Journal cover backgrounds | `assets/journal-backgrounds/default-journal.png`, `assets/journal-backgrounds/meadow-day.png`, `assets/journal-backgrounds/meadow-sunset.png`, `assets/journal-backgrounds/meadow-night.png`, `assets/journal-backgrounds/mountain-sunrise.png`, `assets/journal-backgrounds/moonlit-lake.png`, `assets/journal-backgrounds/summer.png`, `assets/journal-backgrounds/winter.png` | Eight generic wide diary covers. `default-journal` was added 2026-09-06 as a non-nature default cover with a generic indoor stationery scene. `meadow-day`, `meadow-sunset`, and `meadow-night` were added 2026-09-06 as a free-user meadow time-of-day trio, generated with the built-in image tool as distinct scenery-first soft low-poly level-3 covers. `mountain-sunrise` was kept from the previous 2026-09-06 level-3 scenery-first pass. `moonlit-lake`, `summer`, and `winter` were regenerated 2026-09-06 with the built-in image tool as scenery-first soft low-poly level-3 covers. No third-party image inputs, text, logos, people, characters, recognizable real locations, branded products, named artist/studio/franchise references, or watermarks. Discarded prior covers: spring, fall, cozy-reading-nook, school, office, rainy-window, greenhouse, cafe-morning. Draft; human IP/design review required before release. |
...
| Pattern backgrounds | `assets/patterns/pattern-spring.png`, `assets/patterns/pattern-summer.png`, `assets/patterns/pattern-autumn.png`, `assets/patterns/pattern-winter.png` | Four transparent AI-generated wallpaper tiles regenerated 2026-09-06 with the built-in image tool using only project-owned procedural spacing references, then resized and alpha-cleaned for app use. No third-party image inputs, text, logos, people, characters, brand marks, or named artist/studio/franchise references. Each tile uses one repeated motif type only: blossom, sun, leaf, or snowflake. Generated dimensions: `768x768`. Intended display size: subtle full-screen decorative app background. Draft; human IP/design review required before release. See `assets/patterns/README.md`. |
| Memory reaction icons | `assets/reactions/*.png` | Seven transparent PNG reaction icons: cherish, treasure, smile, heavy, tender, stormy, wonder. Regenerated 2026-09-06 with the built-in image tool using simplified one-symbol prompts: heart, gem, smile circle, raincloud, hand/glow, lightning bolt, and star. Uses generic object prompts, soft low-poly journal art direction, no third-party image inputs, no named artist/studio/franchise references, no text, no logos, no people, no platform emoji likeness, and no branded marks. Generated dimensions: `256x256`. Intended display size: 24-42 px in reaction buttons and trays. Draft; human IP/design review required before release. |
