...
| Pattern backgrounds | `assets/patterns/pattern-spring.png`, `assets/patterns/pattern-summer.png`, `assets/patterns/pattern-autumn.png`, `assets/patterns/pattern-winter.png`, `assets/patterns/pattern-star.png` | Five transparent AI-generated wallpaper tiles regenerated 2026-09-05 with the built-in image tool using only project-owned procedural spacing references. No third-party image inputs, text, logos, people, characters, brand marks, or named artist/studio/franchise references. Each tile uses one repeated motif type only: blossom, sun, leaf, snowflake, or star. Generated dimensions: `768x768`. Intended display size: subtle full-screen decorative app background. Draft; human IP/design review required before release. See `assets/patterns/README.md`. |
